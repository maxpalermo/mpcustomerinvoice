...
namespace MpSoft\MpCustomerInvoice\PrintPdf\Templates\Deliveries\Dalavoro;

use MpSoft\MpCustomerInvoice\PrintPdf\PrintManager;
use MpSoft\MpCustomerInvoice\PrintPdf\Templates\PrintTemplateInterface;
use MpSoft\MpCustomerInvoice\PrintPdf\Templates\Deliveries\Dalavoro\Pdf\PdfDelivery;

class DalavoroDeliveryTemplate implements PrintTemplateInterface
{
    ...
    public function render(PrintManager $pdf): void
    {
        ...
        $dalavoroBody = new class($idOrder) {
            ...
            {
                $pdfDelivery = new PdfDelivery($this->idOrder);
                $pdfDelivery->create();
                $pdfDelivery->renderToPdf($pdf);
            }
        };
