...
namespace MpSoft\MpCustomerInvoice\PrintPdf\Templates\Invoices\Dalavoro;

use MpSoft\MpCustomerInvoice\PrintPdf\PrintManager;
use MpSoft\MpCustomerInvoice\PrintPdf\Templates\PrintTemplateInterface;
use MpSoft\MpCustomerInvoice\PrintPdf\Templates\Invoices\Dalavoro\Pdf\PdfInvoice;

class DalavoroInvoiceTemplate implements PrintTemplateInterface
{
    ...
    public function render(PrintManager $pdf): void
    {
        ...
        $dalavoroBody = new class($idOrder) {
            ...
            {
                $pdfInvoice = new PdfInvoice($this->idOrder);
                $pdfInvoice->create();
                $pdfInvoice->renderToPdf($pdf);
            }
        };
