class AdminTableJobsArea {
    ...
    init() {
        console.log("AdminTableJobsArea initialized with tableId:", this.tableId);
        this.initTable();
    }
                    ...
                    formatter: function (value, row, index) {
                        return `
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                <button type="button" class="btn btn-danger btn-sm" name="btn-delete-job-area" title="Elimina settore" data-id="${row.id_customer_invoice_job_area}">
