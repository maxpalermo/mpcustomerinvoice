class AdminTableJobsPosition {
    ...
    init() {
        console.log("AdminTableJobsPosition initialized with tableId:", this.tableId);
        this.initTable();
    }
    ...
    initTable() {
        ...
        $(self.table).bootstrapTable({
            ...
            queryParams: function (params) {
                return {
                    ajax: 1,
                    action: "renderJobsPosition",
                    limit: params.limit,
                    offset: params.offset,
                    search: params.search,
                    sort: params.sort == undefined ? "jpl.name" : params.sort,
            ...
            uniqueId: "id_customer_invoice_job_position",
            ...
            columns: [
                {
                    field: "id_customer_invoice_job_position",
                    title: "ID",
                    align: "right",
                    width: 50,
                    sortable: true,
                    ...
                    formatter: function (value, row, index) {
                        return `
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                <button type="button" class="btn btn-danger btn-sm" name="btn-delete-job-position" title="Elimina settore" data-id="${row.id_customer_invoice_job_area}">
